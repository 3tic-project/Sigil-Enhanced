...
#pragma once
#ifndef KFXPARAGRAPHNORMALIZER_H
#define KFXPARAGRAPHNORMALIZER_H
...
public:
    ...
    struct Analysis {
        ...
        QString reason;
        QString message;
        int spacerParagraphs = 0;
        int zeroHeightSpacers = 0;
        int gapSpacers = 0;
        int meaningfulParagraphs = 0;
        int directTextSegments = 0;
        int directInlineRuns = 0;
