...
void AppearanceWidget::resetXhtmlFormat() {
    ...
    new_format += codec->toUnicode(" h1, h2, h3, h4, h5, h6, ol, ul, li, address, blockquote, dd, dl, fieldset, form, hr, nav, menu, pre");
    new_format += codec->toUnicode(", table, tr, td, th, article\n{ \n  opentag-br: 1 0;\n closetag-br: 0 1;\n}\n\n/* head elements */\n");
    new_format += codec->toUnicode("head, meta, link, title, style, script \n{\n  opentag-br: 1 0;\n closetag-br: 0 1;\n}\n\n/* xml head");
    new_format += codec->toUnicode("er */\n?xml { \n  opentag-br: 0 1;\n}\n\n/* doctype */\n!DOCTYPE { \n  opentag-br: 1 2;\n  attr-fm-r");
    new_format += codec->toUnicode("esv: true;\n}\n\n/* xhtml element */\nhtml { \n  inner-ind-adj:-1;\n}\n\nbody{ \n  opentag-br: 2 1;\n");
    new_format += codec->toUnicode(" closetag-br: 1 1;\n}\n\nh1,h2,h3,h4,h5,h6 { \n  opentag-br: 2 0;\n closetag-br: 0 2;\n}\n\n/* 配置说明");
    new_format += codec->toUnicode("：\n1. HTML代码格式化的配置语言类似CSS，通过选择器筛选具体节点，并由特定的属性指定该类节点的前后换行符数量和缩进级别。(仅)支持元素选择器、通配符选择器，除此以外的选择器类型都不支持。\n");
    new_format += codec->toUnicode("    选择器写法示例：\n    div { ... }\n    div * p { ... }\n    h1,h2,h3 { ... }\n选择器仅支持通过“后代”(A B)，“并集”(A,B");
    new_format += codec->toUnicode(")两种方式进行组合。\n需要注意的是，“后代选择器”的空格后面衔接的【只能是子代，不能隔代】，这点与标准CSS不同。\n\n2. 支持的属性包括：\n   opentag-br: 指定节点的【开始标签");
    new_format += codec->toUnicode("】前后的换行符个数。\n               值输入两个整数，格式为 【 opentag-br: n1 n2 ;】\n               n1 代表标签前面换行符个数，n2 代表标签");
    new_format += codec->toUnicode("后面换行符个数。\n               n1、n2 范围 0 ~ 9，默认值0。\n  closetag-br: 指定节点的【结束标签】前后的换行符个数。\n               范");
    new_format += codec->toUnicode("围 0 ~ 9，默认值 0。\n               格式同上。\n      ind-adj: 调整节点的缩进级别。\n               正数进级，负数退级，例如-2代表缩进退二");
    new_format += codec->toUnicode("级。\n               范围 -9 ~ 9，默认值 0。\ninner-ind-adj: 调整节点内部的缩进级别(不带上节点本身)。\n               范围 -9 ~ 9，");
    new_format += codec->toUnicode("默认值 0。\n attr-fm-resv: 指定开口标签内部是否保留非必需的空格和换行符。\n               范围 true 或 false，默认值 false。\n    @css-");
    new_format += codec->toUnicode("fold: 指定Style节点的CSS是否折叠。\n               范围 true 或 false，默认值 false。\n               特殊属性，不需要写在花括号内部。");
    new_format += codec->toUnicode("\n      @indent: 指定每级缩进符的空格个数。\n               范围 0 ~ 4，默认值 2。\n               特殊属性，不需要写在花括号内部。\n注意：");
    new_format += codec->toUnicode("对于单标签（开口和闭合在同一标签，如 <img/>），开始标签和结束标签换行属性会叠加。\n     注释 <!-- comment --> 同样视为单标签，标签名为“!--”。\n以上所有属性，除了");
    new_format += codec->toUnicode(" opentag-br 和 endtag-br 的值需要输入两个整数，其他属性的值均为一个整数。\n\n3. 换行符合并\n类似于相邻元素的上下margin会合并，在两个相邻节点之间，通过 opent");
    new_format += codec->toUnicode("ag-br、endtag-br 指定的换行符数量取决于更大的那个，而非叠加。这种情况称为“换行符合并”。例如有CSS规则如下： \n    p { open-pre-br:2; close-post-");
    new_format += codec->toUnicode("br:2; }\n那么两个相邻 p 元素之间的换行符数是 2，而非 2+2=4，因为节点之间换行符数量不会叠加。*/");
