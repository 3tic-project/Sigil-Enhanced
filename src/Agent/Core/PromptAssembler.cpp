...
QString PromptAssembler::systemPrompt(AgentMode mode) const
{
    QString prompt = QStringLiteral(
        ...
        "- book.resources, book.spine, book.toc, and style.stylesheets are paginated. When has_more=true, use next_offset to continue; never treat the first page as the complete inventory.\n"
